...
> Um sistema interativo em linha de comando (CLI) desenvolvido em Python para cadastro e gerenciamento de restaurantes e seus cardápios.
...
- [x] **Alternar Estado:** Ativar ou desativar o status de um restaurante.
- [x] **Interface CLI:** Menu interativo de navegação via terminal.
